            ...
            <div className="flex flex-row gap-8 justify-center">
              ...
              {instagramUrl && (
                <a
                  ...
                  className="flex flex-col items-center gap-2 group"
                >
                  <span className="w-14 h-14 rounded-full flex items-center justify-center shadow-sm transition-opacity group-hover:opacity-80" style={{ backgroundColor: "#E1306C" }}>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
