        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              {
                title: "채널 연결 버튼",
                desc: "홈 화면 하단에 네이버 예약, 카카오 채널, 인스타그램, 유튜브 버튼을 원형 아이콘으로 표시할 수 있습니다. URL을 등록한 채널만 자동으로 노출됩니다.",
              },
              {
                title: "자동 복귀",
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-2xl border border-beige-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-3">
                {[
                  ...
                  ["페이지 이동", "상품 목록은 10개씩 페이지로 나뉩니다. 이전·다음 버튼 또는 페이지 번호를 클릭해 바로 이동할 수 있습니다."],
            ...
            <div className="bg-white rounded-2xl border border-beige-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-3">
                {[
                  ...
                  ["유튜브 URL", "입력하면 홈 화면에 유튜브 버튼이 나타납니다."],
                ].map(([label, desc]) => (
                  <div key={label} className="flex gap-3">
                    <span className="shrink-0 text-xs font-medium text-gold-600 w-24 pt-0.5">{label}</span>
                    <p className="text-xs text-gray-500 leading-relaxed">{desc}</p>
            ...
            <div className="bg-white rounded-2xl border border-beige-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-3">
                {[
                  ["상품 유형 숨김", "식물, 조화 등 특정 상품 유형을 손님 화면의 필터에서 숨길 수 있습니다."],
