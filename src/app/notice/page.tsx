        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              {
                title: "홈 화면",
                desc: "접속 시 가장 먼저 보이는 화면. 추천/인기, 모든 상품, 시즌 세 가지 버튼이 있고 각 버튼에 배경 이미지를 설정할 수 있습니다. 하단에 이용 안내·환불 정책·이용약관 링크가 표시됩니다.",
              },
              {
                title: "메인 화면 — 상품 필터",
            ...
            <div className="bg-white rounded-2xl border border-beige-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-3">
                {[
                  ...
                  ["예약 직접 추가", "관리자가 직접 예약을 등록할 수 있습니다. 네이버 예약 텍스트를 붙여넣으면 정보를 자동으로 파싱합니다. 상품 추가 버튼으로 여러 상품을 한 예약에 묶을 수 있으며, 상품별로 유형·이름·금액·메시지카드·쇼핑백·메모를 각각 입력할 수 있습니다. 직접 추가한 예약은 알림이 발송되지 않습니다."],
                  ["상태 관리", "미확인, 준비중, 제작완료, 픽업배송완료, 취소 다섯 단계로 예약 상태를 관리합니다. 취소된 예약은 상태를 변경할 수 없습니다. 복수 상품 예약의 경우 상품 행을 클릭해 상품별로 준비중·제작완료 상태를 개별 관리할 수 있습니다."],
            ...
            <div className="bg-white rounded-2xl border border-beige-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-3">
                {[
                  ...
                  ["계좌 정보", "고객 결제 후 플랫폼에서 매장으로 정산 이체 시 사용되는 계좌입니다. 은행, 계좌번호, 예금주를 입력합니다."],
                  ["통장사본", "정산 계좌를 확인하고 오이체 사고를 방지하기 위해 필요합니다. 계좌 정보 입력 후 통장 앞면 사진 또는 PDF를 업로드합니다. 업로드된 파일은 암호화된 비공개 저장소에 보관됩니다."],
                  ["사업자등록번호", "플랫폼이 매장에 정산금을 지급할 때 세금계산서 발행이 필요합니다. 사업자등록번호 입력 후 '인증' 버튼을 눌러 국세청에서 유효한 사업자인지 확인합니다. 인증은 계속사업자(정상 영업 중)만 가능합니다."],
                  ["예약 알림 정보", "매장 전화번호, 매장 주소, 은행, 계좌번호, 예금주 5개 항목을 모두 입력해야 맞춤 주문 신청이 가능합니다. 맞춤 주문이 활성화된 상태에서는 수정이 불가합니다."],
                ].map(([label, desc]) => (
                  <div key={label} className="flex gap-3">
                    <span className="shrink-0 text-xs font-medium text-gold-600 w-24 pt-0.5">{label}</span>
                    <p className="text-xs text-gray-500 leading-relaxed">{desc}</p>
            ...
            <div className="bg-white rounded-2xl border border-beige-200 overflow-hidden">
              ...
              <div className="px-6 py-4 space-y-3">
                {[
                  ...
                  ["배송비 설정", "고객이 배송비를 몰라 따로 문의하지 않아도 되도록, 주문 시 거리에 따라 배송비가 자동으로 계산되어 표시됩니다. 거리별 배송비를 6구간(1km 이내 / 1~3km / 3~5km / 5~10km / 10~15km / 15~20km)으로 설정합니다. 1km 이내는 필수이며, 나머지 구간은 비워두면 해당 거리의 고객에게 '매장 문의' 안내가 표시됩니다. 20km 초과도 동일하게 매장 문의로 안내됩니다."],
            ...
            <details className="bg-white rounded-2xl border border-beige-200 overflow-hidden group">
              ...
              <ul className="px-6 py-4 space-y-3 border-t border-beige-100">
                {[
                  ...
                  { date: "04.11", text: "이용 안내 페이지 추가 — 손님 화면 홈 하단에 이용 안내·환불 정책·이용약관 링크 추가. 상품 둘러보기부터 맞춤 주문·결제·픽업/배송까지 5단계 이용 흐름 안내", isNew: false },
                  { date: "04.11", text: "예약 직접 추가·수정 — 상품 다중 추가 지원. 상품별 유형·이름·금액·메시지카드·쇼핑백·메모를 각각 입력할 수 있으며 상품 추가 버튼으로 여러 상품을 한 예약에 묶을 수 있음", isNew: false },
                  { date: "04.10", text: "맞춤 주문 — 예약 가능 날짜 오늘로부터 최대 30일 이내로 제한", isNew: false },
                  { date: "04.10", text: "예약 직접 추가·수정 — 결제 상태(미결제/결제 완료) 항목 추가", isNew: false },
